...
class __TwigTemplate_028f793f0a823233c6151edfb57bef8641743c917778628e8f61881635d34840 extends Twig_Template
{
  ...
  <div class=\"panel-body\">
    <form id=\"teachers-form\" class=\"form-horizontal\" method=\"post\" enctype=\"multipart/form-data\">
      ...
      <div class=\"form-group\" id=\"teachers-form-group\">
        ...
        // line 19
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl($this->getAttribute((isset($context["data"]) ? $context["data"] : null), "excel_example", array())), "html", null, true);
        echo "\">点击下载示例说明文件</a>
            <br>
            支持从Excel文件导入
        </div>  
