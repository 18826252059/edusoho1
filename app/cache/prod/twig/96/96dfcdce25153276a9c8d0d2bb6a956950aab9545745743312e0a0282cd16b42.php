...
/* ClassroomBundle:ClassroomFileManage:tbody-tr.html.twig */
class __TwigTemplate_6616bd195d5026ed1ead0d59e673c35ff660b23a352ba80a87c1584a1d81c375 extends Twig_Template
{
    ...
    {
        // line 1
        $context["web_macro"] = $this->loadTemplate("TopxiaWebBundle::macro.html.twig", "ClassroomBundle:ClassroomFileManage:tbody-tr.html.twig", 1);
        // line 2
        $context["quality"] = "";
        // line 3
        echo "  
...
(isset($context["uploadFile"]) ? $context["uploadFile"] : null), "targetType", array()) == "classroom")) {
            // line 29
            echo "      <a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("classroom_manage_file_show", array("id" => $this->getAttribute((isset($context["classroom"]) ? $context["classroom"] : null), "id", array()), "fileId" => $this->getAttribute((isset($context["uploadFile"]) ? $context["uploadFile"] : null), "id", array()))), "html", null, true);
...
(isset($context["uploadFile"]) ? $context["uploadFile"] : null), "metas2", array(), "any", false, true), "sd", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute((isset($context["uploadFile"]) ? $context["uploadFile"] : null), "metas2", array(), "any", false, true), "sd", array()), null)) : (null))) {
  ...
  <td> 
    ...
    {
        return "ClassroomBundle:ClassroomFileManage:tbody-tr.html.twig";
    }
...
/*     {% elseif uploadFile.targetType == 'classroom' %}*/
/*       <a href="{{ path('classroom_manage_file_show', {id:classroom.id, fileId:uploadFile.id}) }}" target="_blank" rel="tooltip" title data-original-title="{{ uploadFile.filename }}"  >{{ uploadFile.filename|sub_text(30) }}</a>*/
/*     {% else %}*/
