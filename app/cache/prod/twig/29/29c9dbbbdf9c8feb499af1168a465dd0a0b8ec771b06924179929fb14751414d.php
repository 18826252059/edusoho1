...
class __TwigTemplate_abdfa2c1eff0c27668af691dcc0a89b91811106d0320b852a92266f31bcc4cd8 extends Twig_Template
{
...
/* */
/* {% set script_controller = 'classroombundle/controller/classroom/thread-list' %}*/
/* {% set nav = 'thread' %}*/
/* {% block description %}{{ classroomDescription|default('')|plain_text(100) }}{% endblock %}*/
/* {% block main %}*/
/* */
/*   {% include 'ClassroomBundle:ClassroomThread/Part:thread-list-header.html.twig' %}*/
/* */
/*   {{ render(controller('TopxiaWebBundle:Thread:list', {request:app.request, target:{type:'classroom', id:classroom.id}, filters:filters})) }}*/
/* */
/* {% endblock %}*/
