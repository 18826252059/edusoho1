...
/* TopxiaAdminBundle:OperationAnalysis:user-sum.table.html.twig */
class __TwigTemplate_3e12f8169772cfae17632f4be213f80ac333adc8995dc86fc676fccb0e0df291 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        echo "      <table id=\"user-table\" class=\"table table-striped table-hover\" data-search-form=\"#user-search-form\">
          ...
          <tbody>
            ";
        // line 13
        if ((isset($context["userSumDetail"]) ? $context["userSumDetail"] : null)) {
            // line 14
            echo "            ";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["userSumDetail"]) ? $context["userSumDetail"] : null));
...
(isset($context["userSumProfiles"]) ? $context["userSumProfiles"] : null), $this->getAttribute($context["data"], "id", array()), array(), "array"), "mobile", array())) {
                    // line 21
                    echo "                    ";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["userSumProfiles"]) ? $context["userSumProfiles"] : null), $this->getAttribute($context["data"], "id", array()), array(), "array"), "mobile", array()), "html", null, true);
...
$context["data"], "type", array()) == "import")) {
    ...
    {
        return "TopxiaAdminBundle:OperationAnalysis:user-sum.table.html.twig";
    }
...
/*                     {{ userSumProfiles[data.id].mobile }}<span class="text-danger">(未绑定)</span>*/
/*                     {% else %}*/
/*                     -- */
/*                     {% endif %}*/
/*                     </td>*/
