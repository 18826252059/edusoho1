...
class __TwigTemplate_87d49a2c7f966a5a4cb8da8200ccd50b610a38bf2535d3975637201558806149 extends Twig_Template
{
  ...
  <td>
    <div class=\"btn-group\">
      <a class=\"btn btn-default btn-sm\" href=\"#modal\" data-toggle=\"modal\" data-url=\"";
        // line 20
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_course_recommend", array("id" => $this->getAttribute((isset($context["course"]) ? $context["course"] : null), "id", array()), "ref" => "recommendList")), "html", null, true);
        echo "\">设置序号</a>
      ...
      <ul class=\"dropdown-menu pull-right\">
        ...
        // line 27
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_course_cancel_recommend", array("id" => $this->getAttribute((isset($context["course"]) ? $context["course"] : null), "id", array()), "target" => (isset($context["target"]) ? $context["target"] : null))), "html", null, true);
