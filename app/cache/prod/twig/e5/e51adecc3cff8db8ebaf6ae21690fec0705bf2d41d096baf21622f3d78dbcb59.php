...
/* CustomAdminBundle:ClassRoomManage/nongzi:nongzi-pick-modal.html.twig */
class __TwigTemplate_760f2cdcc05af1f20e8ba283733b330ced66a0ee0264ba055f356128763d721a extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("TopxiaWebBundle::bootstrap-modal-layout.html.twig", "CustomAdminBundle:ClassRoomManage/nongzi:nongzi-pick-modal.html.twig", 1);
        $this->blocks = array(
    ...
    <div class=\"container-fluid\">
        ...
        // line 21
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("classroom_nongzi_list", array("classroomId" => (isset($context["classroomId"]) ? $context["classroomId"] : null), "type" => (isset($context["type"]) ? $context["type"] : null))), "html", null, true);
        echo "\">";
        if (((isset($context["type"]) ? $context["type"] : null) == "nongzi")) {
            echo "农资";
        } else {
        ...
        if ((isset($context["catalog"]) ? $context["catalog"] : null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["c"]) {
                ...
                echo "\">
                                <a class=\"catalog-tab\" href=\"javascript:void(0);\" data-url=\"";
                // line 26
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("classroom_nongzi_list", array("classroomId" => (isset($context["classroomId"]) ? $context["classroomId"] : null), "type" => (isset($context["type"]) ? $context["type"] : null), "catalogId" => $this->getAttribute($context["c"], "catalogId", array()))), "html", null, true);
                echo "\">
                                    ";
                // line 27
...
";
    ...
    public function block_footer($context, array $blocks = array())
    {
        ...
        echo "    <button id=\"sure\" class=\"btn btn-primary pull-right\"
            data-url=\"";
        // line 72
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("classroom_nongzi_select", array("classroomId" => (isset($context["classroomId"]) ? $context["classroomId"] : null), "type" => (isset($context["type"]) ? $context["type"] : null))), "html", null, true);
        echo "\">添加
    </button>
...
";
    ...
    {
        return "CustomAdminBundle:ClassRoomManage/nongzi:nongzi-pick-modal.html.twig";
    }
...
/*                         <a class="catalog-tab" href="javascript:void(0);" data-url="{{ path('classroom_nongzi_list',{classroomId:classroomId,type:type}) }}">{% if type=="nongzi" %}农资{% else %}教程{% endif %}</a>*/
/*                     </li>*/
/*                     {% if catalog %}*/
/*                         {% for c in catalog %}*/
/*                             <li class="{% if catalogId==c.catalogId %}active{% endif%}">*/
/*                                 <a class="catalog-tab" href="javascript:void(0);" data-url="{{ path('classroom_nongzi_list',{classroomId:classroomId,type:type,catalogId:c.catalogId}) }}">*/
/*                                     {{ c.catalogName }}*/
/*                                 </a>*/
/*                             </li>*/
/*                         {% endfor %}*/
...
/*             data-url="{{ path('classroom_nongzi_select',{classroomId:classroomId,type:type}) }}">添加*/
/*     </button>*/
/*     <button type="button" class="btn btn-link pull-right" data-dismiss="modal">取消</button>*/
/* */
/*     <script>app.load('topxiawebbundle/controller/product/pick')</script>*/
