...
class __TwigTemplate_82a11e108e67e292f2a2bdd874a1cb9c6eb9b20da08cf714747131fa976ed2c8 extends Twig_Template
{
  ...
  <div class=\"tab-header\">
    <ul class=\"clearfix\">
      <li class=\"";
        ...
        echo "\"><a href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath((isset($context["path"]) ? $context["path"] : null), array("category" => "", "fliter" => (isset($context["fliter"]) ? $context["fliter"] : null), "orderBy" => (isset($context["orderBy"]) ? $context["orderBy"] : null))), "html", null, true);
        echo "\">全部</a></li>
      ";
        // line 8
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["cateogory"]) {
            ...
            echo "\"><a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath((isset($context["path"]) ? $context["path"] : null), array("category" => $this->getAttribute($context["cateogory"], "code", array()), "fliter" => (isset($context["fliter"]) ? $context["fliter"] : null), "orderBy" => (isset($context["orderBy"]) ? $context["orderBy"] : null))), "html", null, true);
            echo "\">";
          ...
          ";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["c"]) {
                        ...
                        if (($this->getAttribute($context["loop"], "index", array()) == 1)) {
                            ...
                            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath((isset($context["path"]) ? $context["path"] : null), array("category" => (isset($context["nextCode"]) ? $context["nextCode"] : null), "fliter" => (isset($context["fliter"]) ? $context["fliter"] : null), "orderBy" => (isset($context["orderBy"]) ? $context["orderBy"] : null))), "html", null, true);
                            echo "\">全部</a></li>
            ";
                        }
                        // line 23
                        ...
                        echo "\"><a href=\"";
                        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath((isset($context["path"]) ? $context["path"] : null), array("category" => $this->getAttribute($context["c"], "code", array()), "fliter" => (isset($context["fliter"]) ? $context["fliter"] : null), "orderBy" => (isset($context["orderBy"]) ? $context["orderBy"] : null))), "html", null, true);
                        echo "\">";
...
/*   <div class="tab-header">*/
/*     <ul class="clearfix">*/
/*       <li class="{% if category == '' %}active{% endif %}"><a href="{{ path(path, {category:'',fliter:fliter,orderBy:orderBy}) }}">全部</a></li>*/
...
/*           {% for c in cs %}*/
/*             {% if loop.index == 1 %}*/
/*               <li class="all"><a href="{{ path(path, {category:nextCode,fliter:fliter,orderBy:orderBy}) }}">全部</a></li>*/
/*             {% endif %}*/
