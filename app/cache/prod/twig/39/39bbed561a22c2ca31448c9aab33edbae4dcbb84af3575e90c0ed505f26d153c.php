...
class __TwigTemplate_c7cf73efda5aaa7aa45534483438fca189262c9705b948d193e3a2b71c8ed3db extends Twig_Template
{
...
<form id=\"user-search-form\" class=\"form-inline well well-sm mtl\" action=\"\" method=\"get\" novalidate>
    ...
    <div class=\"form-group\">
      <select class=\"form-control\" name=\"keywordType\">
        ";
        // line 16
        echo $this->env->getExtension('topxia_html_twig')->selectOptions(array("" => "--查询条件--", "nickname" => "用户名", "email" => "邮箱", "truename" => "真实姓名", "idcard" => "身份证号码"), $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "keywordType"), "method"));
        echo "
      </select>
    </div>
    <div class=\"form-group\">
