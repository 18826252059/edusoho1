...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '172.16.3.6', 'port' => 3306, 'dbname' => 'edusoho_com', 'user' => 'longping', 'password' => 'longping130', 'charset' => 'UTF8', 'driverOptions' => array(), 'wrapperClass' => 'Topxia\\Service\\Common\\Connection'), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_55dbb0e9eb06eda88988ccc35b715a7dc23a0f051ac06afa445a1b199ab5fb6f');
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'pczl33725v4ooogoo4w4cws4csk4s4w');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $w = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'pczl33725v4ooogoo4w4cws4csk4s4w', 'main', array('lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
    ...
    {
        $this->services['session.handler.pdo.connection'] = $instance = new \PDO('mysql:host=172.16.3.6;port=3306;dbname=edusoho_com', 'longping', 'longping130');
    ...
    protected function getTemplating_Helper_AssetsService()
    {
        ...
        return $this->services['templating.helper.assets'] = $this->scopedServices['request']['templating.helper.assets'] = new \Symfony\Component\Templating\Helper\CoreAssetsHelper(new \Symfony\Bundle\FrameworkBundle\Templating\Asset\PathPackage($this->get('request'), '6.14.3', '%s?%s'), array());
    }
    ...
    /**
     * Gets the 'topxia.twig.menu_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Topxia\WebBundle\Twig\Extension\MenuExtension A Topxia\WebBundle\Twig\Extension\MenuExtension instance.
     */
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('loginurl', 'http://passport.lpmas.org/user/UserAccountLogin.do');
        $instance->addGlobal('registerurl', 'http://passport.lpmas.org/user/UserAccountRegister.do');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Custom\\WebBundle/Resources/views'), 'CustomWeb');
        $instance->addPath(($this->targetDirs[3].'\\src\\Custom\\AdminBundle/Resources/views'), 'CustomAdmin');
        $instance->addPath(($this->targetDirs[3].'\\src\\Custom\\MobileBundle/Resources/views'), 'CustomMobile');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('pczl33725v4ooogoo4w4cws4csk4s4w');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CustomMobileBundle' => 'Custom\\MobileBundle\\CustomMobileBundle',
            ...
            'database_host' => '172.16.3.6',
            'database_port' => 3306,
            'database_name' => 'edusoho_com',
            'database_user' => 'longping',
            'database_password' => 'longping130',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'zh_CN',
            'secret' => 'pczl33725v4ooogoo4w4cws4csk4s4w',
            'user_partner' => 'none',
            'loginurl' => 'http://passport.lpmas.org/user/UserAccountLogin.do',
            'registerurl' => 'http://passport.lpmas.org/user/UserAccountRegister.do',
            ...
            'kernel.secret' => 'pczl33725v4ooogoo4w4cws4csk4s4w',
            ...
            'twig.options' => array(
                ...
                'paths' => array(
                    'E:\\project\\edusoho\\app/../web/customize' => 'customize',
                    'E:\\project\\edusoho\\app/../src/Topxia/WebBundle/Resources/views' => 'topxiaweb',
                    'E:\\project\\edusoho\\app/../web/themes' => 'theme',
                    'E:\\project\\edusoho\\app/../' => 'root',
                ),
            ...
            'assetic.java.bin' => 'C:\\Program Files\\Java\\jdk1.8.0_05\\bin\\java.EXE',
            'assetic.node.bin' => 'F:\\software\\AppCanStudioPersonalV3.2\\HDK\\emulator\\mas\\\\node.EXE',
