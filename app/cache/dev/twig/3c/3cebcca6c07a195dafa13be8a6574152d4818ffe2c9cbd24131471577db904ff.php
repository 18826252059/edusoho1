...
class __TwigTemplate_18efd5622e428714bb0b6bd74861e01f9cc1a6975596ea64a7045e7dcbf4186e extends Twig_Template
{
      ...
      <div class=\"col-md-4\">
        ...
        if (($this->env->getExtension('topxia_web_twig')->getSetting("coin.coin_enabled") && ($this->env->getExtension('topxia_web_twig')->getSetting("coin.price_type") == "Coin"))) {
            ...
            echo "
                    ";
            // line 56
            if ((($this->getAttribute((isset($context["classroom"]) ? $context["classroom"] : $this->getContext($context, "classroom")), "price", array()) * $this->env->getExtension('topxia_web_twig')->getSetting("coin.cash_rate")) == 0)) {
                // line 57
                echo "                      ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["review"]) {
                  ...
                  <div class=\"media-body\">
                    ...
                    <button class=\"btn btn-success btn-xs\" data-toggle=\"modal\" data-target=\"#modal\" data-url=\"";
                        // line 165
                        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("message_create", array("toId" => $this->getAttribute($this->getAttribute((isset($context["reviewUsers"]) ? $context["reviewUsers"] : $this->getContext($context, "reviewUsers")), $this->getAttribute($context["review"], "userId", array()), array(), "array"), "id", array()))), "html", null, true);
