...
class __TwigTemplate_ed4acd6e4f2dd66b490d6897775beca8cff830115a01db6cfd5a393e12144ebd extends Twig_Template
{
...
";
    ...
    public function block_side($context, array $blocks = array())
    {
        ...
        echo "\"><i class=\"glyphicon glyphicon-picture\"></i> 头像设置</a>
          ...
          <li class=\"list-group-item ";
        // line 21
        if (((isset($context["side_nav"]) ? $context["side_nav"] : $this->getContext($context, "side_nav")) == "security")) {
            echo "active";
        }
        echo "\">
            <a href=\"";
