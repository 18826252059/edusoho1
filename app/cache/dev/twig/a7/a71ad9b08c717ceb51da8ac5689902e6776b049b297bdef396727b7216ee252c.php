...
class __TwigTemplate_1adb45c728ea6ae7f76edc944a88d2ba2ecf52be0f509b65a2c374de3240c34f extends Twig_Template
{
...
/* */
/* {% if mode == 'simple' %}*/
/*   学完了课时 <a class="link-dark" href="{{ path('course_show', {id: props.course.id}) }}" title="来自《{{ props.course.title }}》">{{ props.lesson.title|sub_text(15)}}</a>*/
/* {% elseif mode == 'full' %}*/
/* */
/* {% endif %}*/
